...
const CHIPS_MEASURES = [
  ...
  { key: 'dealer', label: '自營商' }, { key: 'total', label: '三大法人' },
];
const CHIPS_PAGE = 30;
let chipsState = { measure: 'mf', side: 'buy', dayIndex: 0, market: 'all', limit: CHIPS_PAGE };
...
function chipsControlsHtml(data){
  ...
  return '<div class="chips-controls">' +
    '<div class="combo-filter-bar">' + btn('chips-side-btn', 'side', 'buy', '買超', chipsState.side === 'buy') + btn('chips-side-btn', 'side', 'sell', '賣超', chipsState.side === 'sell') + '</div>' +
